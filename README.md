...
##### My inspirantion for this mod was the Boss Race mod by SkruntSkrunt which I thought was an excellent
##### concept, but it did not feel balanced to me and running thru it with friends gave me numerous ideas, so
##### I started looking over all available hotfixes and set out on a 11 months long jouney to create this mod.
...
##### along with various overall weapon improvemts, including a faster reload time on all weapons
...
##### the addition of the unreleased class mod for zane that drop on the arms race map
...
##### custom loot pools assigned to various enemies and the eridian fabricator
...
##### that are action skill start/end dependant have been removed since you can't proc them
...
##### removed heavy weapon penality and player self-splash damage (except of backburner baby projectiles)
...
##### HOWEVER, guests DO see the changes once they pick an item up (euipped or in their backpack)
...
##### starting on this last Halloween, this thing is finally what I wanted in my mind when I first started... YAY!
#####
##### I plan on updating the mod as time moves forward, so feel free to contact me with any feedback.
##### I'm ok with positive and negative feedback, as long as it's constructive (saying, "this sux" helps no one)
